...
public:
  ...
  PathView(QWidget* parent = nullptr, Qt::WFlags f = nullptr);
#else
  PathView(QWidget* parent = nullptr, Qt::WindowFlags f = nullptr);
#endif
...
public:
  PageSorter(Document *doc, int width, QWidget *parent = nullptr);
